...
if __name__ == '__main__':
    ...
    datamodule = IntelDataModule(data_dir=(git_path / "dataset").absolute(), num_workers=num_cpus)
    datamodule.setup()
    ...
    test_metrics = {key: value.tolist() for key, value in trainer.callback_metrics.items()}

    print(f":: {test_metrics=}")

    with open((sm_model_dir / "model_evaluation_metrics.json"), "w") as outfile:
